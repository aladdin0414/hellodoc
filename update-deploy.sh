...
# =============================================================================
# HelloDoc 一键拉取代码、构建打包并部署至远程服务器 / Docker 平台
...
echo -e "${BLUE}==============================================${NC}"
echo -e "${BLUE}   HelloDoc 一键更新 + 打包 + 远程部署工具     ${NC}"
echo -e "${BLUE}==============================================${NC}\n"
...
# 3. 上传并部署至远程服务器
echo -e "${BLUE}[步骤 3/3] 正在传输 JAR 产物并部署至远程服务器 (npm run deploy)...${NC}"
npm run deploy

echo -e "\n${GREEN}🚀 =====================================${NC}"
echo -e "${GREEN}🚀 所有任务完成：更新、打包与远程部署成功！${NC}"
echo -e "${GREEN}🚀 =====================================${NC}"
