...
import AdminAiModelManagement from './admin/AdminAiModelManagement.vue'
...
const tabs = computed(() => [
  ...
  { id: 'ai-models', name: t('admin.aiModel.title'), icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
        ...
        <main class="flex-1 min-w-0">
          <div
            ...
            <div class="p-8">
              ...
              <AdminAiModelManagement v-else-if="activeTab === 'ai-models'" />
